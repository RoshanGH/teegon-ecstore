 ...
 */
final class ectools_payment_plugin_teegonwx extends ectools_payment_app {

	/**
	 * @var string 支付方式名称
	 */
    public $name = '天工支付（微信支付）';//快钱网上支付
    /**
     * @var string 支付方式接口名称
     */
     ...
     * @var string 支付方式key
     */
	public $app_key = 'teegonwx';
	/**
	 * @var string 中心化统一的key
	 */
	public $app_rpc_key = 'teegonwx';
	/**
	 * @var string 统一显示的名称
	 */
    public $display_name = '天工支付(微信)';
    /**
	 * @var string 货币名称
	 */
    public $curname = 'CNY';
	...
	public function __construct($app)
	{
		...
		$this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/' . $this->app->app_id . '/ectools_payment_plugin_teegonwx', 'callback');
